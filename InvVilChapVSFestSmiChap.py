        ...
        while(len(playableActions) > 0 and self.actions > 0):
            if("action-village" in playableActions):
                ...
                if(player == 1):
                    ...
                    for number in range(2):
                        if("action-chapel" in self.hand2):
                            self.hand2.remove("action-chapel")
                        elif("victory-estate" in self.hand2):
                            self.hand2.remove("victory-estate")
                        elif("victory-duchy" in self.hand2):
                            self.hand2.remove("victory-duchy")
                        elif("victory-province" in self.hand2):
                            self.hand2.remove("victory-province")
                        elif("treasure-copper" in self.hand2):
                            self.hand2.remove("treasure-copper")
                        elif("treasure-silver" in self.hand2):
                            self.hand2.remove("treasure-silver")
                        elif("action-militia" in self.hand2):
                            self.hand2.remove("action-militia")
                        elif("action-festival" in self.hand2 and (not ("action-smithy" in self.hand2))):
                            self.hand2.remove("action-festival")
                        elif("treasure-gold" in self.hand2):
                            self.hand2.remove("treasure-gold")
                        elif("action-festival" in self.hand2):
                            self.hand2.remove("action-festival")
                        elif("action-smithy" in self.hand2):
                            self.hand2.remove("action-smithy")
                else:
                    for number in range(2):
                        ...
                        elif("action-festival" in self.hand1 and (not ("action-smithy" in self.hand1))):
                            self.hand1.remove("action-festival")
                        elif("treasure-gold" in self.hand1):
                            self.hand1.remove("treasure-gold")
                        elif("action-festival" in self.hand1):
                            self.hand1.remove("action-festival")
                        elif("action-smithy" in self.hand1):
                            self.hand1.remove("action-smithy")
