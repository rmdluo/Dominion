...
class SingleGame:
    def __init__(self):
        self.file = open("game_WkspGardens_MoneylenderX.txt", "w")
        ...
        # player 2
        self.numMoneylender = 0
        self.limitMoneylender = 1
        
        self.numSilver2 = 0
        self.limitSilver2 = 10
            ...
            if(player == 1):
                ...
                if(8 <= self.coins):
                    ...
                    if(self.provinces <= 4 and self.duchies > 0):
                        ...
                        if(self.numMoneylender < self.limitMoneylender):
                            discard.append("action-moneylender")
                            self.numMoneylender += 1
                            self.coins -= 4
