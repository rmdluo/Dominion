...
class SingleGame:
    def __init__(self):
        self.file = open("game_InvVilChap_VilWitChap.txt", "w")
    ...
    def turn(self, player):
        ...
        if(self.currentPlayer == 1):
            ...
            self.file.write(str(self.turnNumber) + ": " + str(self.provinces) + ", " + str(self.numWitch2) + ", " + str(self.numVillage2) + "\n")
            hand = self.hand2
    ...
    def action(self, player):
        ...
        while(len(playableActions) > 0 and self.actions > 0):
            if("action-village" in playableActions):
            ...
            elif("action-witch" in playableActions):
                self.file.write("play witch\n")
                ...
                self.actions -= 1
                playableActions.remove("action-witch")
            ...
            if(player == 1):
                ...
                if(self.turnNumber <= 4):
                    if(self.coins <= 3):
                        ...
                        discard.append("action-witch")
                        self.coins -= 5
                        self.numWitch2 += 1
                    else:
                        discard.append("action-silver")
                        self.numSilver2 += 1
                        self.coins -= 3
                    ...
                    if(self.coins >= 3 and self.numVillage2 < self.limitVillage2 and self.numVillage2 + self.numVillage1 < 10):
                        ...
                        self.numGold2 += 1
                        self.coins -= 6
                    elif(self.coins >= 5 and self.numWitch2 < self.limitWitch2):
                        discard.append("action-witch")
                        self.numWitch2 += 1
                        self.coins -= 5
