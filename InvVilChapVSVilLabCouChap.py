...
class SingleGame:
    def __init__(self):
        self.file = open("game_InvVilChap_VilLabCouChap.txt", "w")
        ...
        # player 2
        self.numVillage2 = 0
        self.numLaboratory2 = 0
        self.numCouncilRoom2 = 0
        self.limitVillage2 = 9
        self.limitLaboratory2 = 2
        self.limitCouncilRoom2 = 0
        
        self.numChapel2 = 0
        self.numMilitia2 = 0
        self.limitMilitia2 = 2
    ...
    def simulateRun(self):
        ...
        while(self.provinces > 0 and emptyPiles < 3 and self.turnNumber < 2000):
            ...
            if(self.numVillage1 + self.numVillage2 == 10):
                emptyPiles += 1
            if(self.numLaboratory1 + self.numLaboratory2 == 10):
                emptyPiles += 1
            if(self.numCouncilRoom2 == 10):
                emptyPiles += 1
            if(self.numMilitia2 == 10):
                emptyPiles += 1
    ...
    def turn(self, player):
        ...
        if(self.currentPlayer == 1):
            ...
            self.file.write(str(self.turnNumber) + ": " + str(self.provinces) + ", " + str(self.numCouncilRoom2) + ", " + str(self.numVillage2) + ", " + str(self.numLaboratory2) + ", " + "\n")
            hand = self.hand2
    ...
    def action(self, player):
        ...
        while(len(playableActions) > 0 and self.actions > 0):
            if("action-village" in playableActions):
            ...
            elif("action-council-room" in playableActions):
                self.file.write("play council room\n")
                ...
                self.actions -= 1
                playableActions.remove("action-council-room")
                ...
                if(player == 2):
                    for number in range(2):
                        if("action-chapel" in self.hand1):
                            ...
                            self.hand1.remove("action-laboratory")
                            self.discard1.append("action-laboratory")
                        elif("action-village" in self.hand1 and self.hand1.count("action-village") > self.hand1.count("action-inventor")):
                            self.hand1.remove("action-village")
                            self.discard1.append("action-village")
                        elif("action-inventor" in self.hand1):
                            self.hand1.remove("action-inventor")
            ...
            if(player == 1):
                ...
                if(self.turnNumber <= 4):
                    if(self.coins <= 3):
                        ...
                        discard.append("action-council-room")
                        self.coins -= 5
                        self.numCouncilRoom2 += 1
                    else:
                    ...
                    if(8 <= self.coins):
                        ...
                        if(self.numCouncilRoom2 < self.limitCouncilRoom2 and self.numLaboratory2 < self.limitLaboratory2):
                            if(self.numCouncilRoom2 < self.numLaboratory2):
                                discard.append("action-council-room")
                                self.numCouncilRoom2 += 1
                                self.coins -= 5
                            else:
                                discard.append("action-laboratory")
                                self.numLaboratory2 += 1
                                self.coins -= 5
                        elif(self.numCouncilRoom2 < self.limitCouncilRoom2):
                            discard.append("action-council-room")
                            self.numCouncilRoom2 += 1
                            self.coins -= 5
                        elif(self.numLaboratory2 < self.limitLaboratory2):
                            discard.append("action-laboratory")
                            self.numLaboratory2 += 1
                            self.coins -= 5
                        ...
                        self.duchies -= 1
                        self.coins -= 5
                    elif(self.coins >= 4 and self.numMilitia2 < self.limitMilitia2):
                        discard.append("action-militia")
                        self.numMilitia2 += 1
                        self.coins -= 4
