...
class SingleGame:
    def __init__(self):
        self.file = open("game_MLX_VilSmiMarChap.txt", "w")
        ...
        # player 1
        self.numMoneylender1 = 0
        self.limitMoneylender1 = 1
    ...
    def turn(self, player):
        ...
        if(self.currentPlayer == 1):
            self.file.write(str(self.turnNumber) + ": " + str(self.provinces) + ", " + str(self.numSilver1) + ", " + str(self.numDuchies1) + "\n")
            hand = self.hand1
            ...
            if("action-village" in playableActions):
                ...
                if(player == 2):
                    while(len(self.hand1) > 3):
                        ...
                        elif("treasure-copper" in self.hand1 and "action-moneylender" in self.hand1):
                            self.hand1.remove("action-moneylender")
                            self.discard1.append("action-moneylender")
            ...
            if(player == 1):
                if(8 <= self.coins):
                    ...
                    if(self.provinces <= 4 and self.duchies > 0):
                        ...
                        if(self.numMoneylender1 < self.limitMoneylender1):
                            discard.append("action-moneylender")
                            self.numMoneylender1 += 1
                            self.coins -= 4
